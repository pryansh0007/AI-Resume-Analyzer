...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='Pryansh@123',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: #021659;">Priyanshu Sahu and Dev Agarwal </a></b>' 
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                try:
                    ...
                    st.text('Interests: '+str(resume_data['interests']))
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://dnoobnerd.netlify.app/" style="text-decoration: none; color: grey;">Priyanshu Sahu and Dev Agarwal</a> through 
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Priyanshu Sahu and Dev Agarwal ! Total %d " % values + " User's Have Used Our Tool : )")                
